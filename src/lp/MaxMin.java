...
public class MaxMin extends Strategy {
    ...
    public void execute() throws InterruptedException {
        ...
        while (true) {
            ...
            while (!playComplete) {
                ...
                this.maxMin(U1, U2, labelsP1, labelsP2, myStrategy, player1);
    ...
    public void maxMin(int[][] M1, int[][] M2, String[] labelsP1, String[] labelsP2, PlayStrategy myStrategy,
            boolean player1) {
        int rows = M1.length;
        ...
        if (player1) {
            ...
            lb[lb.length - 1] = getLowerBound(M1);
